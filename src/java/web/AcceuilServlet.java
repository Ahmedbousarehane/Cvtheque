...
public class AcceuilServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            ...
            try {
                ...
                PreparedStatement ps = conn.prepareStatement("SELECT count(*) as tot FROM `entreprise` WHERE Etat=\"non valide\"");
                ...
                Logger.getLogger(AcceuilServlet.class.getName()).log(Level.SEVERE, null, ex);
            }
